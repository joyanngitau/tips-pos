...
<span>Expiry Date : </span><input type="text" placeholder="mm/dd/yyyy" style="width:265px; height:30px;" name="exdate" /><br>
...
<span>Quantity sold: </span><input type="number" style="width:265px; height:30px;" id="txt22" name="qty_sold" Required ><br>
